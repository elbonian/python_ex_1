...
# your code here
# We use the split() function to break a string into a list of items separated by the parameter
# Note that we use ". " as this removes the space leading into sentences after the first one
sentences = s.split(". ")
